    ...
    ***************************************************************************** */
    ...
    function createScripts(src) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            script.onload = function () { return resolve(src); };
        });
    }
     ...
     */
    var JSONToExcel = function (options) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, name, _b, data, _c, header, _d, skipHeader, cloneData, ws, wb;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, loadXLSX()];
                case 1:
                    _e.sent();
                    _a = options.name, name = _a === void 0 ? 'excel' : _a, _b = options.data, data = _b === void 0 ? [] : _b, _c = options.header, header = _c === void 0 ? {} : _c, _d = options.skipHeader, skipHeader = _d === void 0 ? true : _d;
    ...
    var excelToJSON = function (file) { return __awaiter(void 0, void 0, void 0, function () {
        var suffix;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            reader.onload = function (e) {
                                if (!e.target)
                                    return reject('event target undefined');
                                var t = e.target;
